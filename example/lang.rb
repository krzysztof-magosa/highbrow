...
if File.exists? '/tmp/lang.net'
  ...
  net.layers.push Highbrow::Neural::Layer.new(neurons: $alphabet.count, bias: true, activation: nil)
  net.layers.push Highbrow::Neural::Layer.new(neurons: 35, bias: true, activation: Highbrow::Neural::Activation::Sigmoid.new)
  net.layers.push Highbrow::Neural::Layer.new(neurons: langs.count, activation: Highbrow::Neural::Activation::Sigmoid.new)
  net.finalize!
end
